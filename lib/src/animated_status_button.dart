  ...
  buildProgressWidget() {
    return Center(
      ...
      child: AnimatedOpacity(
        ...
        // 时间
        duration: Duration(milliseconds: (milliseconds * 0.2).toInt()),
        child: Padding(
...
class AnimatedStatusController {
  late AnimatedStatusButtonListener _animatedStatusButtonListener;
  ...
  /// 选择
  void select() => _animatedStatusButtonListener(false);

  /// 关闭
  void close() => _animatedStatusButtonListener(true);
}
